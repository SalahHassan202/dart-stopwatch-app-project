...
void main()
{
  ...
  // listen ====> البرنامج واقف سامع أول ما المستخدم يكتب حاجه يرد عليه
  // while(true) ===> سريعه جدا مبيلحقش يشوف التايمر ف فكل مره هيطبع التايمر ب زيرو 
  // و بالتالي هنلجا لحل ان احنا نستخدم listen 
  // عشان نسمع كل حرف المستحدم بيكتبه و بالتالي نطلع التايمر زي ما هز و يكون التايمر متغير ف كل مره يتم الطباعه فيها
